...
- Repeat the same To access the eye muscle settings on your custom fbx

- Enter the settings you screenshot earlier
...
This section is interesting if you have existing animation controller logic which enables custom toggles or systems on your avatar.
...
- Assign the SimpleFTControls menu under File

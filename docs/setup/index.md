...
This section of the documentation is dedicated to how to install one of Hash's Face Tracking Add-ons without any prior knowledge of VRChat avatar creation
...
- VRCFT is available on [Steam](https://store.steampowered.com/app/3329480/VRCFaceTracking/)

- Download the module for your tracking device in the module registry

> If you need more info [here's the documentation](https://docs.vrcft.io/docs/intro/getting-started) on how to set-it up

## Launch VRChat

VRChat is available on [Steam](https://store.steampowered.com/app/438100/VRChat/)
...
You can browse this documentation to learn more on how to [apply the add-on to your custom avatar](/customisation/apply-to-custom-avatar.md) or [fix common issues](/common-issues/)
